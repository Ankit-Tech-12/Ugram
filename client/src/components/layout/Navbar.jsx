...
//           className="
//             w-9 h-9 rounded-full bg-primary/30
...
//             <div className="flex items-center gap-2 px-3 py-2 hover:bg-red-500/10 text-red-400 rounded-lg cursor-pointer">
//               <LogOut size={16} />
//               Logout
//             </div>
//           </motion.div>
        ...
        {dropdownOpen && (
          ...
          >
            ...
            <div
              ...
              className="flex items-center gap-2 px-3 py-2 hover:bg-red-500/10 text-red-400 rounded-lg cursor-pointer"
            >
              <LogOut size={16} />
              Logout
            </div>
